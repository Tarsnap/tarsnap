...
## Current-master rejoin (2026-09-19)

This branch rebases the one-line PR826 cleanup onto upstream master `ff046af1a24850475fb80bf89d197c9b46dca268` without copying the stale whole writer. The unpatched current-master writer blob is `e459cc729f7611d1bd804967ef0ff9875f7294fa`; the patched writer blob is `4f16ea0e6dd99a3137b539f577afdefd14eb5a97`. The historical local/hosted results below were produced on the earlier PR826 generation; fresh current-master execution is a separate gate and must not be inferred from those receipts.
...
git show ff046af1a24850475fb80bf89d197c9b46dca268:tar/write.c > /tmp/pr826-before.c
...
Production writer blob on current-master rejoin: `4f16ea0e6dd99a3137b539f577afdefd14eb5a97`.
Current-master pre-fix writer: `e459cc729f7611d1bd804967ef0ff9875f7294fa`.
